...
public final class WalldownloadkotlinBinding implements ViewBinding {
  @NonNull
  ...
  private WalldownloadkotlinBinding(@NonNull LinearLayout rootView, @NonNull ImageView Game,
  ...
  @NonNull
  public static WalldownloadkotlinBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static WalldownloadkotlinBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.walldownloadkotlin, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static WalldownloadkotlinBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new WalldownloadkotlinBinding((LinearLayout) rootView, Game, ImageView4, ImageView5,
